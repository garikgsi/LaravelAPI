...
class InvoiceItem extends ABPTable
{
    ...
    public function __construct()
    {
        ...
        $this->model([
            ["name" => "invoice_id", "type" => "key", "table" => "invoices", "table_class" => "Invoice", "title" => "Заказ", "require" => false, "default" => 1, "index" => "index", "show_in_table" => false, "show_in_form" => false],
            ...
            ["name" => "price", "name_1c" => "Цена", "type" => "money", "title" => "Цена c НДС", "require" => true, "index" => "index", "show_in_table" => true, "out_index" => 2, "show_in_form" => true],
            ["name" => "summa", "name_1c" => "Сумма", "type" => "money", "title" => "Сумма c НДС", "require" => true, "index" => "index", "show_in_table" => true, "out_index" => 4, "show_in_form" => true],
