...
class StartController extends Controller
{
    public function move_remains()
    {
        ...
        $truncate_tables = [
            "sklad_register", "sklad_receives", "sklad_receive_items", "sklad_moves",
        ...
        foreach ($sklads as $sklad) {
            ...
            foreach ($receives as $receive) {
                ...
                if ($data->count() > 0) {
                    ...
                    $receive_sum = 0;
                    // заносим позиции
                    $data->orderBy('_sklad_remains.id')->chunk(100, function ($sklad_receive_items) use ($move_array, $receive_id, $new_db, &$receive_sum, $nds_id, $nds_stavka) {
